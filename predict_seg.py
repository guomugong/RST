...
model_path='./snapshot/drive_seg.pth'


if source_domain == "rc-slo":
...
if target_domain == "rc-slo":
    test_data_path = "./dataset/rc-slo/test/"
...
if __name__ == "__main__":
    with torch.no_grad():
        ...
        if target_domain == "rimone" or target_domain == 'refuge' or target_domain == "idrid" or target_domain == "refuge2":
